...
(function ($) {
  $(document).ready(function () {
    ...
    function onKeyPressTemporizadorTiempoBase(event){
    ...
    function onKeyUpTemporizadorTiempoBase(e){
      if ($(this).val() === '') {
    ...
    function onClickNuevoTimesheet(event){
      $('#lnk-span-guardar-timesheet').text('Iniciar');
    ...
    function onClickGuardarTimesheet(event){
      create_update();
      event.preventDefault();
    };
    ...
    function onClickEditarTimesheet(event){
    ...
    function onClickBorrarTimesheet(event){
      var id = $(this).getIdSplit('-')[1];
    ...
    function onClickLinkReloj(event){
      var el = $(this);
    ...
    function bind_click_lnk_reloj() {
      $('.lnk_editar_timesheet').unbind('click').click(onClickEditarTimesheet);
      $('.lnk_borrar_timesheet').unbind('click').click(onClickBorrarTimesheet);
      $('.lnk_reloj').unbind('click').click(onClickLinkReloj);
      $('.lnk_borrar_timesheet').unbind(REFRESH_EVENT).bind(REFRESH_EVENT, $.refreshTotalHours);
      $('#lnk-guardar-timesheet').unbind(REFRESH_EVENT).bind(REFRESH_EVENT, $.refreshTotalHours);
      $('.lnk_reloj').die(REFRESH_EVENT).live(REFRESH_EVENT, $.refreshTotalHours);
      $('#temporizador_tiempo_base').unbind('keypress').keypress(onKeyPressTemporizadorTiempoBase)
                                    .unbind('keyup').keyup(onKeyUpTemporizadorTiempoBase);
      $('a.lnk-nuevo-timesheet').unbind('click').click(onClickNuevoTimesheet);
      $('#lnk-guardar-timesheet').unbind('click').click(onClickGuardarTimesheet);
    }
